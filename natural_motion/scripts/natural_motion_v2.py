...
# smooth trajectory
traj = generate_smooth_trajectory(plan1, jerk_profiles.DDDU)  # different jerk profiles can be used from jerk_profiles.py
...
# smooth trajectory
traj2 = generate_smooth_trajectory(plan2, jerk_profiles.DDDU)  # different jerk profiles can be used from jerk_profiles.py
